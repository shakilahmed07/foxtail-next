...
const SingleNft = ({ data }) => {
  return (
    <>
      <div className="mt-5 bg-white  rounded-sm shadow-xl md:mx-3 ">
        ...
        <div className="dark:bg-slate-800">
          {/* <div> */}
            <h1 className=" text-black dark:text-white font-medium text-base leading-5 tracking-wide my-2	 md:leading-10md:text-2xl  ml-4 md:my-1.5 md:leading-7  md:text-xl">
              {data?.title}
            </h1>
          ...
          {/* </div> */}
          <div className="bg-fuchsia-200 h-0.5  mx-4 md:mt-2 dark:bg-fuchsia-900"></div>
          <div className="flex justify-between items-center py-3">
            <div className="flex items-center">
              ...
              />
              <h1 className="text-black font-medium text-xl mx-1 dark:text-white">
                {data?.price}
              </h1>
              <h2 className=" font-medium gray-text dark:text-white">
                {data?.dollar}
              </h2>
            </div>
            <div>
